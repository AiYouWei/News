...
import org.androidx.frames.libs.volley.Cache.Entry;
        ...
        while (true) {
            ...
            try {
                ...
                if (statusCode == HttpStatus.SC_NOT_MODIFIED) {
                    ...
                    if (entry == null) {
                        return new NetworkResponse(HttpStatus.SC_NOT_MODIFIED, null, responseHeaders, true, SystemClock.elapsedRealtime()
                                - requestStart);
                    }
                ...
                return new NetworkResponse(statusCode, responseContents, responseHeaders, false, SystemClock.elapsedRealtime()
                        - requestStart);
