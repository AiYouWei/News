...
public class CropperImageActivity extends BaseActivity {
    ...
    protected Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 0x111) {
                ...
                String path = ImageUtils.saveAsBitmap(CropperImageActivity.this, itbmp, Constants.folderName, null);
                itbmp.recycle();
    ...
    private void show() {
        if (flag == 0) {
            crop_img.setImageResource(R.mipmap.crop_img_sma);
            flag = 1;
            ...
            crop_img.setImageResource(R.mipmap.crop_img_big);
            flag = 0;
