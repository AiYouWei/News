...
public class NewsPushService extends UmengBaseIntentService {
    private static final String TAG = NewsPushService.class.getName();
    ...
    protected void onMessage(Context context, Intent intent) {
        ...
        try {
            ...
            LogUtil.e(true, "NewsPushService", "onMessage message " + message);
            ...
            LogUtil.e(true, "NewsPushService", "onMessage ====", e);
        }
    }
}
